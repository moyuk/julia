...
LLVM_CMAKE += -DLLVM_TOOLS_INSTALL_DIR=$(shell $(PYTHON) $(call python_cygpath,$(JULIAHOME)/contrib/relative_path.py) $(build_prefix) $(build_depsbindir))
LLVM_CMAKE += -DLLVM_UTILS_INSTALL_DIR=$(shell $(PYTHON) $(call python_cygpath,$(JULIAHOME)/contrib/relative_path.py) $(build_prefix) $(build_depsbindir))
